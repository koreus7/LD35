...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(52)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)60,(int)3355443,tmp22,HX_HCSTRING("HaxePunk_Project","\x22","\xf1","\x67","\x78"),null(),null());
	}
return null();
}
