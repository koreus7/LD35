...
{
HX_STACK_FRAME("Main","new",0x6616a5cb,"Main.new","Main.hx",5,0x087e5c05)
HX_STACK_THIS(this)
...
Void Main_obj::init( ){
{
		HX_STACK_FRAME("Main","init",0xea732345,"Main.init","Main.hx",13,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(13)
		::MainScene tmp = ::MainScene_obj::__new();		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(13)
